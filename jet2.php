...
$pdf=new FPDF();
$pdf->AddPage();    
$pdf->Image('logos/jet.png',10,5,30);
...
$pdf->Cell(20 ,5,"{$date}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'9W-0817',0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(30 ,5,"{$from}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'16:10',0,0);
$pdf->SetFont('Arial','',12);
...
$pdf->Ln(7);
$pdf->Cell(20 ,5,'Issuing Airline:',0,0); $pdf->Cell(11,5,'',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(49 ,5,'Jet Airways Ltd.',0,0);$pdf->SetFont('Arial','B',12);
...
$pdf->Ln(10);
$pdf->Cell(70 ,5,'Base Fare:',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(100 ,5,"INR 6830",0,0);$pdf->SetFont('Arial','B',12);
$pdf->Ln(7);
...
$pdf->Ln(7);
$pdf->Cell(70 ,5,'TOTAL COST',0,0); $pdf->SetFont('Arial','',15); $pdf->Cell(100 ,5,"INR 8805",0,0);$pdf->SetFont('Arial','B',12);
