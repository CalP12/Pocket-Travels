...
$pdf=new FPDF();
$pdf->AddPage();    
$pdf->Image('logos/indi.png',10,5,30);
...
$pdf->Cell(20 ,5,"{$date}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'6E-8497',0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(30 ,5,"{$from}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'11:40',0,0);
$pdf->SetFont('Arial','',12);
...
$pdf->Ln(7);
$pdf->Cell(20 ,5,'Issuing Airline:',0,0); $pdf->Cell(11,5,'',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(49 ,5,'Indigo Ltd.',0,0);$pdf->SetFont('Arial','B',12);
...
$pdf->Ln(10);
$pdf->Cell(70 ,5,'Base Fare:',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(100 ,5,"INR 9600",0,0);$pdf->SetFont('Arial','B',12);
$pdf->Ln(7);
...
$pdf->Ln(7);
$pdf->Cell(70 ,5,'TOTAL COST',0,0); $pdf->SetFont('Arial','',15); $pdf->Cell(100 ,5,"INR 11,575",0,0);$pdf->SetFont('Arial','B',12);
