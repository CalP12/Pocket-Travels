...
$pdf=new FPDF();
$pdf->AddPage();    
$pdf->Image('logos/airindia.png',10,5,30);
...
$pdf->Cell(20 ,5,"{$date}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'IX-1813',0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(30 ,5,"{$from}",0,0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(20 ,5,'13:05',0,0);
$pdf->SetFont('Arial','',12);
...
$pdf->Ln(7);
$pdf->Cell(20 ,5,'Issuing Airline:',0,0); $pdf->Cell(11,5,'',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(49 ,5,'Air India Ltd.',0,0);$pdf->SetFont('Arial','B',12);
...
$pdf->Ln(10);
$pdf->Cell(70 ,5,'Base Fare:',0,0); $pdf->SetFont('Arial','',12); $pdf->Cell(100 ,5,"INR 6800",0,0);$pdf->SetFont('Arial','B',12);
$pdf->Ln(7);
...
$pdf->Ln(7);
$pdf->Cell(70 ,5,'TOTAL COST',0,0); $pdf->SetFont('Arial','',15); $pdf->Cell(100 ,5,"INR 8775",0,0);$pdf->SetFont('Arial','B',12);
...
$pdf->Output(F,'tickets/ticket.pdf');
    ...
    $mail->Port       = 58;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
